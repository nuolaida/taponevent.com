...
<ul class="main_page_menu">
	<li><a href="{"/admin.php?module=newsletters&action=info"|amake_url}" title="{"add"|translate}"><i class="material-icons">add</i></a></li>
</ul>
	...
	<tbody>
		{foreach from=$list item=item}
			<tr>
				...
				<td>
					<a href="{"/admin.php?module=newsletters&action=info&id={$item.id}"|amake_url}"><i class="material-icons">edit</i></a>
				</td>
			</tr>
		{/foreach}
	</tbody>
