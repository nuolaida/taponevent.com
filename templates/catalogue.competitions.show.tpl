            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <h3 class="name font-28 text-gray mb-0 mt-0">
                        <a href="{"/index.php?module=catalogue&action=competitions"|make_url}">{"competitions"|translate}</a>
                    </h3>
                                ...
                                <div class="media border-bottom p-15 mb-20 bg-light">
                                    <div class="media-body">
                                        <ul class="list-inline font-30 p-15">
                                            {if $data.link_social_website}<li class="pl-15 pr-15"><a href="{$data.link_social_website}"><i class="fa fa-globe text-theme-colored"></i></a></li>{/if}
                                            {if $data.link_social_facebook}<li class="pl-15 pr-15"><a href="{$data.link_social_facebook}"><i class="fa fa-facebook text-theme-colored"></i></a></li>{/if}
                                            {if $data.link_social_youtube}<li class="pl-15 pr-15"><a href="{$data.link_social_youtube}"><i class="fa fa-youtube text-theme-colored"></i></a></li>{/if}
                                            {if $data.link_social_twitter}<li class="pl-15 pr-15"><a href="{$data.link_social_twitter}"><i class="fa fa-twitter text-theme-colored"></i></a></li>{/if}
                                            {if $data.link_social_instagram}<li class="pl-15 pr-15"><a href="{$data.link_social_instagram}"><i class="fa fa-instagram text-theme-colored"></i></a></li>{/if}
                                        </ul>
                                    </div>
                                </div>
                            </div>
